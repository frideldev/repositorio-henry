...
function fizzBuzz(numero) {
  ...
  return (Number.isInteger(numero/3)&&Number.isInteger(numero/5))?'fizzbuzz':(Number.isInteger(numero/3))?'fizz':(Number.isInteger(numero/5))?'buzz':numero;
}
...
function operadoresLogicos(num1, num2, num3) {
  ...
  return (num1<0||num2<0||num3<0)?'Hay negativos':(num1==0 || num2===0||num3===0)?'Error':(num1>0&&num1>num2&&num1>num3)?"Número 1 es mayor y positivo":(num3>num1&&num3>num2)?num3+1:false;
